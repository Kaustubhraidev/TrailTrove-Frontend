...
const AddEditTravelStory = ({
  ...
  return (
    <div className="relative shadow-lg shadow-slate-700 p-2">
        ...
        <div>
          <div className="flex items-center gap-3 bg-cyan-50/50 p-2 rounded-l-lg">
            ...
            <button class="" onClick={onClose}>
              <IoMdClose className="text-xl text-slate-900" />
            </button>
          </div>
      ...
      <div>
        <div className="flex bg-fuchsia-200 rounded-2xl pr-2 pl-2 pb-2 flex-1 flex-col gap-2 pt-4">
          <label className="input-label font-semibold text-black">TITLE</label>
          ...
          <div className="flex flex-col gap-2 mt-4">
            <label className="input-label text-black font-semibold">STORY</label>

            <textarea
              type="text"
              className="text-sm text-slate-950 outline-none bg-slate-100 p-2 rounded-2xl border-2 border-amber-900 rotate-1"
          ...
          <div className="pt-3">
            <label className="input-label font-semibold text-black">VISITED LOCATIONS</label>
